    ...
    return (
        <div>
            <Container>
                ...
                <div className=" lg:flex justify-between py-[ py-[40px]">
                    <div className="lg:w-[32%]">
                        <div className=" border-[1px] border-[#FFF6FB] h-[300px] lg:w-[400px] px-[10px] py-3 bg-[#FFF6FB] ">
                            <div className="">
                    ...
                    <div className="lg:w-[32%]">
                        <div className=" border-[1px] border-[#FFF6FB]  lg:h-[300px] lg:w-[400px]  px-[10px] py-3 bg-[#FFF6FB]">
                            <div className="">
                                <h4 className=' font-hakto font-medium text-[26px] text-[#151875]'>23% off in all products</h4>
                                <p className=' font-hakto font-normal text-[16px] text-[#FB2E86] border-b-[1px] border-[#FB2E86] inline-block'>View Collection</p>
                            </div>
                            <div className=" ">
                                <img src={Trends} className=' lg:translate-x-[20%]' alt="" />
                            </div>
                        </div>
                    </div>
